...
public class MainActivity extends AppCompatActivity {
    ...
    private URL createURL(String city){
        ...
        String baseUrl = getString(R.string.web_service_url); // ex: http://agent-weathermap-env.eba.../api/weather?APPID=

        try {
            String urlString = baseUrl + "api/weather?city=" + URLEncoder.encode(city, "UTF-8") +
                    "&days=7&APPID=" + apiKey;
            ...
            try {
                ...
                for (int i = 0; i < list.length(); i++) {
                    ...
                    weatherList.add(new Weather(
                            day.getString("date"), // passa direto a string "YYYY-MM-DD"
